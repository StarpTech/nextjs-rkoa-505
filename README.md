...
1. Copy the `.env.example` file to `.env` and fill in the required values1112233434334.
2. Install the dependencies and run the complete example in one command:wedewedewedewqwdqwddewde
d
```shell
