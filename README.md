...
1. Copy the `.env.example` file to `.env` and fil.dqwdqwdwqwedewdew
2. Install the dependencies and run the complete ededewcscsdcdweddewdewdewdewdwdewdxddewwedweddwedwedewdewwedewdewdampqwswedewdewqswqqwdqwdqdle in one qwdewdewedwedwewdqwwqd:ddewdewdewd
dweew
```shell
