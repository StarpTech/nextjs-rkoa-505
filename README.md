...
1. Copy the `.env.example` file to `.env` and fill in the required sssdddssssdssddsssdddsdddddsssdddsssdddd.ssdddsssssssxdddddddd
2. Install the dependencies and run the complete example in one command:ddd
dd
```shell
